...
Rozróżniaj osobę mówiącą do kamery i narrację spoza kadru. Gdy użytkownik pisze „narracja”, „lektor”, „voiceover” albo „narration voice”, wybierz narrację spoza kadru, w języku ustalonym z użytkownikiem. Samo słowo „voiceover” nie określa języka. Stosuj [dobór silnika głosu](references/dobor-glosu.md): dla angielskiego wbudowany głos Higgsfield, dla polskiego lub bardziej charakterystycznego głosu ElevenLabs, także gdy taki głos ma mówić po angielsku. Jawny wybór użytkownika ma pierwszeństwo. Wybierz język w obsługiwanym parametrze lub selektorze; nie wymyślaj nieistniejących pól. Dla polskiego lektora zastosuj [polską narrację](references/polska-narracja.md): Seedance 2.5 tworzy obraz, a ElevenLabs osobny głos do montażu. ElevenLabs może działać przez dostępny wariant Higgsfield. W mowie do kamery zachowaj format i zapewnij synchronizację ust z docelowym audio. Domyślnie dobierz głos kobiecy do bohaterki i męski do bohatera; jawny wybór użytkownika ma pierwszeństwo. Aktor może pokazywać i obsługiwać produkt, ale nie porusza ustami jak podczas mówienia. Jeżeli referencja już ma lektora, zachowaj ten sposób opowiadania, o ile brief nie mówi inaczej. To pełnoprawny format, nie wyłącznie naprawa słabej wymowy generatora.

## 3. Plan gotowy do generacji

Przeczytaj [promptowanie](references/promptowanie.md) i dopasuj wykonanie według [możliwości modeli](references/mozliwosci-modeli.md). Rdzeń nie wymaga konkretnego modelu. Higgsfield jest opcjonalnym, preferowanym połączeniem do produkcji; nie wprowadzaj innych obowiązkowych platform generacji obrazu. Silnik głosu dobierz osobno: ElevenLabs dla polskiego i specjalnych wymagań głosowych.
...
Planuj rozwój wydarzeń wewnątrz ujęć, nie tylko kolejne kadry. Dla demonstracji określ działanie, widoczny skutek oraz zmianę tempa; przy dynamicznej referencji zachowaj także energię gestów i ruch w przestrzeni. Korzystaj z [dynamiki sceny](references/ruch-i-klatki.md#dynamika-sceny): konkretny ruch osoby i produktu prowadzi uwagę, a kamera może go wspierać. Same cięcia, najazdy na zdjęcia i zmiany póz nie zastępują wydarzeń. Krótka pauza na dostrzeżenie wyniku pozostaje częścią rytmu.
...
Przy limicie 7 zdjęć najpierw rezerwuj miejsca dla tożsamości i produktu. Można dołączyć wybrane klatki, jeśli zostaje miejsce; pozostałe zdarzenia opisz czasowo. Nie wysyłaj całej siatki klatek w nadziei na obejście limitu. Przy większym limicie nie ograniczaj się do kilku obrazów: dla Seedance wykorzystuj obszerny zestaw źródłowych klatek obejmujący ważne fazy i szczegóły ruchu, nawet kilkanaście lub kilkadziesiąt, jeśli są użyteczne i obsługiwane. Podane przez użytkownika 40 obrazów wymaga potwierdzenia w aktualnym interfejsie; do limitu wliczaj także wzorce postaci i produktu. Nie przenoś budżetu Gemini na Seedance.

Gdy referencja zawiera charakterystyczny gest, pracę palców, ruch kamery lub interakcję z produktem, obejrzyj całą czynność w czasie i zastosuj [naturalny ruch i dobór referencji](references/ruch-i-klatki.md). Zachowaj kierunek, rytm, kontakt i widoczny skutek działania. Klatki służą analizie oraz wybranym wskazówkom wizualnym; nie narzucaj zestawu sztywnych póz z osobnymi czasami. Opisz ciągłą czynność w przybliżonym oknie sekundowym. Do generacji dołącz bezpośrednio użyteczne klatki wyodrębnione z MP4 albo obsługiwany wycinek wideo do ruchu, obok osobnych wzorców własnej postaci i produktu; sprawdź role i limity. Przy złożonym geście uwzględnij więcej źródłowych faz kontaktu, nacisku i reakcji. Nie odtwarzaj klatek generatorem obrazów i nie twórz pośredniej serii zdjęć nowej postaci w kolejnych pozach. Analiza tekstowa nie zastępuje dołączenia dostępnych, obsługiwanych referencji źródłowych. W demonstracji aplikacji sprawdzaj osobno gest dłoni i rzeczywistą reakcję interfejsu — nieruchomy ekran z widoczną dłonią nie zastępuje zaplanowanej interakcji.
